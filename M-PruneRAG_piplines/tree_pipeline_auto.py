...
class Generator:
    ...
    def generate(self, **sampling_params) -> List[str]:
        ...
        strategy.save_results_memory(result_path, "tree", self.config.split, self.total_time, self.start_time, self.retrieval_num, avg_tree_depth=avg_tree_depth, apply_backoff=False,overall_father_avg=overall_father_avg, overall_brother_avg=overall_brother_avg, final_father_hit_avg=final_father_hit_avg)
