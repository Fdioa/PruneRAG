...
from scripts.prompts import (
                    ...
                    get_subqueries_qwen3_8b_auto_wo_ans,
                    ...
                    get_subqueries_llama3_8b_auto_wo_ans,
...
class Generator:
    def __init__(self, config: Config):
        ...
        if 'qwen' in self.config.model_name:
            ...
            self.subquery_template = get_subqueries_qwen3_8b_auto_wo_ans()
            ...
            self.subquery_template = get_subqueries_llama3_8b_auto_wo_ans()
    ...
    def generate(self, **sampling_params) -> List[str]:
        ...
        strategy.save_results_memory(result_path, "tree_wo_ans", self.config.split, self.total_time, self.start_time, self.retrieval_num, avg_tree_depth=avg_tree_depth, apply_backoff=False,overall_father_avg=overall_father_avg, overall_brother_avg=overall_brother_avg, final_father_hit_avg=final_father_hit_avg)
...
if __name__ == "__main__":
    ...
    print("Starting tree_wo_ans pipeline...\n Time:", datetime.now())
