...
from scripts.prompts import (
                    ...
                    get_subqueries_qwen3_8b_auto_wo_ent,
                    ...
                    get_subqueries_llama3_8b_auto_wo_ent,
...
class Generator:
    def __init__(self, config: Config):
        ...
        if 'qwen' in self.config.model_name:
            ...
            self.subquery_template = get_subqueries_qwen3_8b_auto_wo_ent()
            ...
            self.subquery_template = get_subqueries_llama3_8b_auto_wo_ent()
            ...
            if all_matches:
                ...
                try:
                    ...
                    if json_type == "decomposition" and "subquery1" in parsed_json and "subquery2" in parsed_json:
                        print("成功解析到 decomposition 模式的 JSON")
                        processed_item = {
                            "type": "decomposition",
                            "subqueries": [
    ...
    def generate(self, **sampling_params) -> List[str]:
        ...
        strategy.save_results_memory(result_path, "tree_wo_ent", self.config.split, self.total_time, self.start_time, self.retrieval_num, avg_tree_depth=avg_tree_depth, apply_backoff=False,overall_father_avg=overall_father_avg, overall_brother_avg=overall_brother_avg, final_father_hit_avg=final_father_hit_avg)
...
if __name__ == "__main__":
    ...
    print("Starting tree_wo_ent pipeline...\n Time:", datetime.now())
